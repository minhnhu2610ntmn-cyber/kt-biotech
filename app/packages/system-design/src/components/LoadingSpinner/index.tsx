      ...
      <div className='relative mb-4'>
        ...
        <div className='absolute inset-2 flex items-center justify-center'>
          <div className='w-4 h-4 relative'>
            ...
            <div
              className='absolute right-0 top-0 w-0.5 h-4 bg-gradient-to-b from-green-500 to-blue-500 rounded-full animate-pulse'
              style={{ animationDelay: '0.5s' }}
            ></div>
            <div className='absolute left-0 top-2 w-3 h-0.5 bg-blue-400 rounded-full animate-bounce'></div>
            <div
              className='absolute right-0 top-3 w-3 h-0.5 bg-green-400 rounded-full animate-bounce'
