    ...
    <div className={cn('relative group', className)}>
      ...
      {navigation && customNavigation && (
        <div className='flex justify-center items-center mt-6 space-x-3'>
          <button
            className={cn(
              'slider-button-prev flex items-center justify-start pl-1 w-16 h-8 rounded-full transition-all duration-200',
          ...
          <button
            className={cn(
              'slider-button-next flex items-center justify-end pr-1 w-16 h-8 rounded-full transition-all duration-200',
