...
export const partners: Partner[] = [
  {
    ...
    website: 'https://kt-biotech.com',
    description: 'Công ty công nghệ sinh học hàng đầu',
  },
  {
    id: '2',
    name: 'Diag',
    logo: '/images/diag.png',
    website: 'https://diag.vn',
    description: 'Trung tâm chẩn đoán y khoa',
  },
  {
    id: '3',
    name: 'PIHCM',
    logo: '/images/pi.png',
    website: 'https://pihcm.edu.vn',
    description: 'Viện Pasteur TP.HCM',
  },
  {
    id: '4',
    name: 'Bệnh Viện Hoàn Mỹ Sài Gòn',
    logo: '/images/hoanmi.png',
    website: 'https://hoanmysaigon.com',
    description: 'Bệnh viện tư nhân hàng đầu',
  },
  {
    id: '5',
    name: 'Fimex',
    logo: '/images/fimex.png',
    website: 'https://fimex.com',
    description: 'Công ty thương mại quốc tế',
  },
  {
    id: '6',
    name: 'Vinmec',
    logo: '/images/yduoc.png',
    website: 'https://vinmec.com',
    description: 'Hệ thống bệnh viện Vinmec',
  },
  {
    id: '7',
    name: 'FPT Software',
  ...
  },
  {
    ...
    description: 'Tập đoàn viễn thông Viettel',
  },
  {
    id: '9',
    ...
    description: 'Samsung Electronics Vietnam',
  },
  {
    id: '10',
    name: 'Intel Vietnam',
    logo: 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1f?w=200&h=100&fit=crop',
    website: 'https://intel.com.vn',
    description: 'Intel Corporation Vietnam',
  },
  {
    id: '11',
    name: 'Microsoft Vietnam',
    logo: 'https://images.unsplash.com/photo-1521737711867-e3b97375f902?w=200&h=100&fit=crop',
    website: 'https://microsoft.com/vn',
    description: 'Microsoft Vietnam',
  },
  {
    id: '12',
    name: 'Google Vietnam',
    ...
    description: 'Google Vietnam',
  },
  {
    id: '13',
    name: 'IBM Vietnam',
    logo: 'https://images.unsplash.com/photo-1560472354-b33ff0c44a43?w=200&h=100&fit=crop',
    website: 'https://ibm.com/vn',
    description: 'IBM Vietnam',
  },
  {
    id: '14',
    name: 'Oracle Vietnam',
    logo: 'https://images.unsplash.com/photo-1559136555-9303baea8ebd?w=200&h=100&fit=crop',
    website: 'https://oracle.com/vn',
    description: 'Oracle Corporation Vietnam',
  },
  {
    id: '15',
    name: 'Cisco Vietnam',
    logo: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=200&h=100&fit=crop',
    website: 'https://cisco.com/vn',
    description: 'Cisco Systems Vietnam',
  },
];
