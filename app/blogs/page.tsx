...
const mockCategories: BlogCategory[] = [
  { id: '1', name: 'Research', slug: 'research', description: 'Scientific research and discoveries' },
  { id: '2', name: 'Medicine', slug: 'medicine', description: 'Medical advances and treatments' },
  { id: '3', name: 'Business', slug: 'business', description: 'Business and commercial aspects' },
  { id: '4', name: 'Technology', slug: 'technology', description: 'Technological innovations' },
  { id: '5', name: 'Industry News', slug: 'industry-news', description: 'Latest industry developments' },
  { id: '6', name: 'Regulatory', slug: 'regulatory', description: 'Regulatory updates and compliance' },
  { id: '7', name: 'Clinical Trials', slug: 'clinical-trials', description: 'Clinical research and trials' },
  { id: '8', name: 'Drug Discovery', slug: 'drug-discovery', description: 'Pharmaceutical research' },
  { id: '9', name: 'Diagnostics', slug: 'diagnostics', description: 'Diagnostic technologies' },
  { id: '10', name: 'Therapeutics', slug: 'therapeutics', description: 'Therapeutic developments' },
  { id: '11', name: 'Biomarkers', slug: 'biomarkers', description: 'Biomarker research' },
