#!/usr/bin/env python3
"""
Update VI articles with full Vietnamese content (description + content)
"""
...
# Full content for Vietnamese blog articles
vi_articles_content = {
    559: {
        "description": "KTBioTech tự hào giới thiệu kit PCR thế hệ mới với độ nhạy cao, giúp phát hiện sớm các bệnh lý nguy hiểm.",
        "content": """<h2>Kit PCR thế hệ mới</h2>
...
<p>Sản phẩm đã được kiểm chứng bởi các viện nghiên cứu hàng đầu Việt Nam.</p>"""
    ...
    561: {
        "description": "Tham gia hội thảo để cập nhật những xu hướng mới nhất trong ngành công nghệ sinh học y tế.",
        "content": """<h2>Hội thảo khoa học 2024</h2>
...
<p>Thời gian: 9:00 - 16:00, ngày 20/06/2024</p>
<p>Địa điểm: Hội trường KTBioTech</p>"""
    },
    563: {
        "description": "KTBioTech ký kết hợp tác với Viện Pasteur TP.HCM để phát triển các kit chẩn đoán mới.",
...
<p>Sự hợp tác này sẽ thúc đẩy sự phát triển của ngành công nghệ sinh học Việt Nam.</p>"""
    ...
    565: {
        "description": "KTBioTech vinh dự nhận Giải thưởng Sáng tạo TPHCM 2024 cho sản phẩm kit test tiên tiến.",
        "content": """<h2>Giải thưởng Sáng tạo TPHCM 2024</h2>
...
<p>Những giải thưởng này là ghi nhận cho những nỗ lực không ngừng của đội ngũ nghiên cứu.</p>"""
    ...
    567: {
        "description": "Đội ngũ R&D của KTBioTech đang nghiên cứu ứng dụng công nghệ CRISPR trong y học.",
        "content": """<h2>Nghiên cứu Gene Editing</h2>
<p>Đội ngũ R&D của KTBioTech đang nghiên cứu ứng dụng công nghệ CRISPR-Cas9.</p>
...
<p>Công nghệ này mở ra kỷ nguyên mới trong y học chính xác tại Việt Nam.</p>"""
    ...
    595: {
        "description": "Bài viết mới về nghiên cứu và phát triển công nghệ sinh học tại KTBioTech.",
        "content": """<h2>Tin mới từ KTBioTech</h2>
<p>Cập nhật những tin tức mới nhất về nghiên cứu và phát triển.</p>
...
def update_article_content(article_id, description, content):
    """Update article with description and content"""
    payload = {
        "data": {
...
print("📝 Updating VI articles with full content...")
print("=" * 60)

for article_id, data in vi_articles_content.items():
    success, msg = update_article_content(
...
print("\n🎉 Done! Updated articles with description and content")
